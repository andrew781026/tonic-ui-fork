...
editUrl: https://adc.github.trendmicro.com/Consumer-Frontend/consumer-tonic-ui/blob/dev/astro/src/content/docs/guides/get-started.mdx
---
...
<Tabs>
  ...
  <TabItem label="React">
    ```js
    npm i -s git+ssh://git@adc.github.trendmicro.com:Consumer-Frontend/consumer-tonic-ui-react.git
    ```
  </TabItem>
</Tabs>
